common_dict_config = {
    'link_method': 'NPR', # 'TAGME|FALCON2|REL|ReFinED|NPR'
    'embedding_method': 'wikidata_rdf2vec_sg_200_1', # 'wikidata_rdf2vec_sg_200_1' #'wiki2vec' #kgtk
    'test_collection_name': 'acordar1', # 'ntcir15', # 'acordar1|ntcir15|ntcir16|BDR'
...
link_res_dir_path = f"/home/xxx/code/erm/data/anno_rel_files/ntcir16/query/"

sparse_methods = ['BM25', 'FSDM', 'LMD', 'TFIDF'] if common_dict_config['test_collection_name'] == 'acordar1' else ['BM25']
...
if common_config.test_collection_name == 'acordar1':
    topic_link_res_path = f'/home/xxx/code/erm/data/topic_link_results/{common_config.test_collection_name}_{common_config.train_or_test}_topic_link_result.json' 
    if retrieve_config.use_top_link_pb_query: topic_link_res_path = topic_link_res_path.replace('.json', '_top_link_pb.json')
        ...
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/acordar1_expanded_query_id_link_result.json'
    elif retrieve_config.use_REL_query:
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/acordar1_query_link_result_REL.json'
    elif retrieve_config.use_best_rho_query:
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/acordar1_test_topic_link_result_best_rho.json'
    elif retrieve_config.use_expanded_entity_query:
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/acordar1_test_topic_link_result_expanded_entities.json'
    elif retrieve_config.use_ngram_query:
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/acordar1_test_query_link_result_ngram_merged.json'
    elif retrieve_config.use_cos_score_entity_query:
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/acordar1_test_query_link_result_with_cos_score.json' # f'/home/xxx/code/erm/data/topic_link_results/acordar1_test_query_link_result_ngram_with_cos_score.json'
else: 
    if retrieve_config.use_ngram_query:
        topic_link_res_path = '/home/xxx/code/erm/data/topic_link_results/ntcir_test_query_link_result_ngram_merged.json'
    else:
        topic_link_res_path = f'/home/xxx/code/erm/data/topic_link_results/ntcir_{common_config.train_or_test}_topic_link_result.json'
