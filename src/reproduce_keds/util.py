...
def get_metadata_dict():
    ...
    if common_config.test_collection_name == 'acordar1':
        metadata_dict_path = '/home/wqluo/code/Scripts-for-DPR/file/ctxs_for_embedding/metadata.tsv'
        m_str_dict = {}
        ...
        cursor.execute('SELECT dataset_id, metadata from ntcir_metadata_info;')
        # print('ntcir_metadata not implemented yet')
        m_str_dict = {}
        for (dataset_id, metadata) in cursor.fetchall():
            m_str_dict[dataset_id] = metadata
        return m_str_dict

def get_5split_query():
    query_5split_dir_path = '/home/wqluo/code/Scripts-for-DPR/file/query_for_validation/for_acordar1/'
    queries_split = {}
    name2id = json_load('/home/wqluo/code/erm/data/topic_link_results/name2id.json')
    binary_train_data_dir_path = '/home/wqluo/code/erm/data/binary_train_data/'
...
def get_topk_candidate_set(k):
    ...
    for method_name in sparse_methods:
        sparse_res_path = f'/home/wqluo/code/erm/data/retrieve_results/{config.test_collection_name}/candidates/{method_name} test_top100_sorted.json'
...
def merge_two_score(score1, score2, op, w1=0.5):
    """
    score_op notes:
