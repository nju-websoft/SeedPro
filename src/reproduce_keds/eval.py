...
qrels_path = f'/home/xxx/code/erm/data/qrels/{config.test_collection_name}_{config.train_or_test}_qrels.json'
...
def simple_eval(res_dict, k, ground_truth_qrels = qrels):
    ...
    if config.test_collection_name == 'ntcir15':
        ...
        mean_all_dict = mean_dict
    elif config.test_collection_name == 'acordar1':
...
id2name = json_load(f'/home/xxx/code/erm/data/topic_link_results/id2name_{config.test_collection_name}_{config.train_or_test}.json')
...
predict_res_path = '/home/xxx/code/fastText/pred.json'
...
def get_candidate_path(method):
   candidate_res_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/candidates/{method} {config.train_or_test}_top100_sorted.json'
   return candidate_res_path

def eval_keds(retrieve_res_dir_path, indicate_id = 0):
    ...
    for method in sparse_methods:            
        ...
        # simple_eval(rerank_res, candidate_res_path.replace('.json', '_eval.json'))


def get_best_ndcg5():
    from util import json_load
    # assert config.test_collection_name == 'ntcir', "only for ntcir, for acordar1, you should use 'merge_folds_results method'"
    
    multi_run_name = 'multi_run/37'
    multi_run_dir_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/metadata/' + multi_run_name
...
def merge_folds_result(save_ind = ''):
    if save_ind != '':
        if not os.path.exists(f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/{config.data_field}/{config.res_dir_name}/{save_ind}/'):
            os.mkdir(f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/{config.data_field}/{config.res_dir_name}/{save_ind}/')
    # multi_run_id = 'multi_run_matrix2'

    retrieve_res_dir_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/{config.data_field}/'
    ...
    for method in sparse_methods:
        ...
        for i in range(start_ind, end_ind + 1):
            ...
            if not os.path.exists(res_path): 
                assert 0, res_path
            candidate_res_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/candidates/{method} top100_sorted.json'
...
def eval_multi_run():
    suffix = 'multi_run/37/'
    multi_run_dir_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/{config.data_field}/{suffix}'
...
def eval_merged(type, ind, multi_run_or_signle = 'multi_run'):
    ...
    if multi_run_or_signle == 'multi_run':
        ...
        merged_dir_perfix = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/metadata/multi_run/{multi_run_suffix}'
    else:
        merged_dir_perfix = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/rerank/{config.embedding_method}/metadata/single_run/{ind}'
...
def eval_one_monobert_res():
    res_path = '/home/xxx/code/erm/data/retrieve_results/monobert_results/test_linear_combs_ntcir/3/BM25 [m]_comb_org.json' # '/home/xxx/code/erm/data/retrieve_results/monobert_results/monoBERT_res_ntcir_train_org.json'
    ...
    if config.test_collection_name == 'ntcir':
                candidate_res_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/candidates/{method} {config.train_or_test}_top100_sorted.json'
    else: candidate_res_path = f'/home/xxx/code/erm/data/retrieve_results/{config.test_collection_name}/candidates/{method} top100_sorted.json'
...
def eval_monobert_combs():
    ...
    res_dir_path = '/home/xxx/code/erm/data/retrieve_results/monobert_results/multi_run_linear_combs_ntcir_train/'
    for subdir in os.listdir(res_dir_path):
        ...
        for method in sparse_methods:
            ...
            # '/home/xxx/code/erm/data/retrieve_results/monobert_results/multi_run_linear_combs_ntcir/2/BM25 [m]_org.json' 
            # # f'/home/xxx/code/erm/data/retrieve_results/monobert_results/each_sparse_results/{method} monoBERT_res_list_acordar1_org.json' # f'/home/xxx/code/erm/data/retrieve_results/monobert_results/multi_run_linear_combs/2/{method}_org.json'
...
def eval_dpr_res():
    dpr_rerank_dir_path = '/home/xxx/code/erm/data/retrieve_results/condenser/from_cocondenser_marco/acordar1/'
    # '/home/xxx/code/erm/data/retrieve_results/condenser/ft_nq_pt/' # '/home/xxx/code/erm/data/retrieve_results/condenser/new_ntcir'
...
def eval_bert_reranker_result():
    # find path of all /home/xxx/code/erm/data/retrieve_results/bert_reranker/results/**/**/test.json
    bert_reranker_dir_path = '/home/xxx/code/erm/data/retrieve_results/bert_reranker/results_finetune/' # '/home/xxx/code/erm/data/retrieve_results/bert_reranker/results/'
...
def tmp_eval():
    res_dir_path = '/home/xxx/code/erm/data/retrieve_results/bert_reranker/simple_arrange/pt_ft/acordar1' # '/home/xxx/code/erm/data/retrieve_results/acordar1/rerank/{config.embedding_method}/metadata/single_run/1124/BM25 [m]/with_sparse_merged/BM25 [m]/with_ir_sota_merged'
